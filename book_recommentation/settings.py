"""
Django settings for book_recommentation project.
...
MIDDLEWARE = [
    ...
    "accounts.middleware.custom_middleware.JsonWebTokenMiddleWare",

]

ROOT_URLCONF = 'book_recommentation.urls'
...
WSGI_APPLICATION = 'book_recommentation.wsgi.application'
